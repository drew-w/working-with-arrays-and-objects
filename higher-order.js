...
//Code Here
let evenNumbers = mixedNumbers.filter((elem, index, arr) => elem % 2 === 0)
...
//Code Here
let postTaxPrices  = prices.map((elem, index, arr) => elem *= 1.07 );
...
//Code Here
let totalPopulation = populations.reduce((acc, cur) => acc + cur, 0)
...
//Code Here
let myStrongest = monstersInYourPocket.filter((elem, index, arr) => elem.CP > 200)
...
let orderTotals = orders.map((elem, index, arr) => {
